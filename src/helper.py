# THIS IS FOR THE DEFAULT AND CUSTOME PROMPT
...
# THIS IS FOR QUESTION AND ANSWER PROMPT. It takes context from the knowledge base, and take questions from the user, and 
